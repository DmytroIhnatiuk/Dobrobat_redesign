...
{
    add_image_size('service_thumb', 180, 180, false);
    add_image_size('service_image', 585, 410, false);
    add_image_size('result_before', 285, 360, false);
    add_image_size('result_after', 385, 480, false);
    add_image_size('about_service_image', 385, 500, false);
    add_image_size('product', 285, 305, false);
    add_image_size('product_main', 485, 440, false);
    add_image_size('product_thumb', 98, 89, false);
