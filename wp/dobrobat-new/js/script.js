...
/* harmony import */ var _modules_popups__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/popups */ "./src/js/modules/popups.js");
/* harmony import */ var _modules_thankPage__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/thankPage */ "./src/js/modules/thankPage.js");
/* harmony import */ var _modules_helpers__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/helpers */ "./src/js/modules/helpers.js");
/* harmony import */ var _modules_donatePage__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/donatePage */ "./src/js/modules/donatePage.js");
/* harmony import */ var _modules_academy__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/academy */ "./src/js/modules/academy.js");
/* harmony import */ var _modules_eventsPage__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/eventsPage */ "./src/js/modules/eventsPage.js");
...
window.addEventListener("DOMContentLoaded", () => {
  try {
    ...
    if (document.querySelector(".main__page")) {
      ...
      if (!isEn) {
        document.querySelector("[data-help]").addEventListener("click", () => {
          document.querySelector('[data-target="#materials"]').click();
        });
        const attention = document.querySelector(".form__attention").querySelector(".descr");
        const attentionTogglers = attention.querySelectorAll('[data-attention]');
        attentionTogglers.forEach(toggle => {
    ...
    Object(_modules_helpers__WEBPACK_IMPORTED_MODULE_18__["getElement"])('[data-gtag]', true).forEach(gtagBtn => {
      gtagBtn.addEventListener('click', e => {
        e.preventDefault();
        gtag('event', gtagBtn.dataset.gtag);
        location.href = gtagBtn.href;
      });
    });
    headerFixed();
    (_getElement = Object(_modules_helpers__WEBPACK_IMPORTED_MODULE_18__["getElement"])('#menu-btn')) === null || _getElement === void 0 ? void 0 : _getElement.addEventListener('click', function () {
    ...
    Object(_modules_donatePage__WEBPACK_IMPORTED_MODULE_19__["default"])();
    Object(_modules_thankPage__WEBPACK_IMPORTED_MODULE_17__["default"])();
    Object(_modules_gallerySlider__WEBPACK_IMPORTED_MODULE_4__["default"])();
    Object(_modules_eventsPage__WEBPACK_IMPORTED_MODULE_21__["default"])();
    window.addEventListener("scroll", () => {
      headerFixed();
    });

    if (Object(_modules_helpers__WEBPACK_IMPORTED_MODULE_18__["getElement"])('.academy')) {
      Object(_modules_academy__WEBPACK_IMPORTED_MODULE_20__["default"])();
    }
    ...
    async function send(data) {
      try {
        const result = await fetch("https://script.google.com/macros/s/AKfycbx77gWMlEZXErhxsnVGtkFKxQ7SIsRA9AO9udomKapmott1FL2JjZpg0fYLOu_WhNZ_/exec", {
          method: "POST",
          body: data
        });
    ...
    const getUtmParameter = (url, data) => {
      if (url) {
        const urlValues = url.substr(1).split("&");
  ...
  if (document.querySelector(".news-page")) {
    document.querySelectorAll(".news-item__title").forEach(item => {
      if (item.innerText.length > 50) {
        item.innerText = item.innerText.substr(0, 50) + `...`;
      }
    });
  }

  if (document.querySelector(".advertisement")) {
    const mBtns = document.querySelectorAll("[data-modals]");
    mBtns.forEach(item => {
      item.addEventListener("click", () => {
        const modal = document.querySelector(".modal");

        if (item.dataset.modals === "form") {
          new _modules_popups__WEBPACK_IMPORTED_MODULE_16__["default"](".modal-form").openModal();
          return;
        }

        const modalBody = modal.querySelector(".modal__body");
        modalBody.innerHTML = `
        <div class="ads-item__modal">
        <div class="wrapper fz-18">
    <h4><strong class="d-block fz-24"> Увага! </strong> Пам’ятайте про заходи безпеки: </h4>
    <ul>
            <li>
              Всі оголошення на сайті - безкоштовні. Якщо від вас вимагають гроші на карту - це шахраї.
            </li>
        ...
        <div class="number"> Номер телефону власника: <strong>${item.dataset.modals}</strong></div>
  
        <a href="tel:${item.dataset.modals}" class="btn fz-18">
          <svg data-v-72457066="" viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="telephone fill" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-telephone-fill b-icon bi">
            <g data-v-72457066="">
              <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"></path>
            </g>
          </svg>
          Зв’язатись з власником</a>
        <button type="button" class="btn  btn_outline modal__close fz-18"> Закрити </button>
  
      </div>
      `;
        new _modules_popups__WEBPACK_IMPORTED_MODULE_16__["default"](".modal-number").openModal();
      });
    });
  }
...
/* harmony import */ var _selected__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./selected */ "./src/js/modules/selected.js");
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base */ "./src/js/modules/base.js");
...
class Dropdown {
  ...
  openMenu(el) {
    ...
    if (!el.classList.contains("open") && allDrops) {
      this.removeOpen(allDrops);
  ...
  selectItem(target, replace, attr) {
    target.classList.add("select");
    let text = replace.innerText;
    let data = replace.getAttribute(`data-${attr}`);

    switch (attr) {
      case "region":
        _selected__WEBPACK_IMPORTED_MODULE_0__["default"].region = data;
        break;

      case "city":
        _selected__WEBPACK_IMPORTED_MODULE_0__["default"].city = data;
        break;

      case "category":
        _selected__WEBPACK_IMPORTED_MODULE_0__["default"].category = data;
        break;
    }

    if (text.length >= 18) {
      target.innerText = `${text.slice(0, 15)}...`;
    } else {
      target.innerText = text;
    }

    target.setAttribute(`data-${attr}`, data);
  }

  init(attr) {
    if (this.dropdown) {
      const select = this.dropdown.querySelector(".dropdown__selected");
      ...
      this.dropdown.addEventListener("click", e => {
        if (!e.target.classList.contains("dropdown__menu")) {
          this.openMenu(this.dropdown);
          this.renderCities();
        }
      });
      this.menu.addEventListener("click", e => {
        if (e.target.classList.contains("dropdown__item")) {
          this.selectItem(select, e.target, attr);
        }
      });
    } else {
      return;
  ...
  renderCategories() {
    ...
    if (categoryDropdown) {
      ...
      this.menu.appendChild(this.renderItems(categories, fragment, "category"));
    }
  }

  renderCities() {
    const regionDropdown = document.querySelector('[data-city="dropdown"]');

    if (regionDropdown) {
      const fragment = document.createDocumentFragment();

      if (_selected__WEBPACK_IMPORTED_MODULE_0__["default"].region === "") {
        this.menu.innerHTML = "";
        const li = document.createElement("li");
        li.classList.add("dropdown__item");
        li.innerText = "Выбирете регион...";
        li.dataset.city = "city";
        this.menu.appendChild(li);
      } else {
        this.menu.innerHTML = "";
        const region = regionsList.find(item => {
          let findItem = {};

          for (let key in item) {
            if (key.toLowerCase() == _selected__WEBPACK_IMPORTED_MODULE_0__["default"].region) {
              findItem = { ...item.cities
              };
              return findItem;
            }
        ...
        this.menu.appendChild(this.renderLi("city"));
        this.menu.appendChild(this.renderItems(region.cities, fragment, "city"));
      }
    }
  }
  ...
  renderRegions() {
    // if (this.dropdown) {
    const fragment = document.createDocumentFragment();
    this.menu.appendChild(this.renderItems(_base__WEBPACK_IMPORTED_MODULE_1__["regions"], fragment, "region")); // }
  }

  renderProfessions() {
    const regionDropdown = document.querySelector('[data-profession="dropdown"]');

    if (regionDropdown) {
      const dropdownWrapper = regionDropdown.querySelector(".dropdown-wrapper").querySelector(".row");
      const fragment = document.createDocumentFragment(); // dropdownWrapper.appendChild(this.renderLi("region"));

      dropdownWrapper.appendChild(this.renderItems(_base__WEBPACK_IMPORTED_MODULE_1__["profession"], fragment, "profession"));
    }
  }

  renderItems(arr, fragment, attr) {
    arr.forEach(item => {
      const li = document.createElement("li");
      li.classList = "dropdown__item";
      li.innerText = item;
      li.dataset[`${attr}`] = item;
  ...
  renderLi(attr) {
    const li = document.createElement("li");
    li.classList = "dropdown__item not-active";

    switch (attr) {
      case "region":
        li.innerText = "Батальйон...";
        break;
...
/* harmony import */ var _selected__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selected */ "./src/js/modules/selected.js");
/* harmony import */ var _modalsEvents__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modalsEvents */ "./src/js/modules/modalsEvents.js");
...
class Form {
  constructor(form) {
    ...
    this.btnText = this.btn.innerText;
    this.types = this.form.querySelectorAll('[name="checkbox-types"]');
    this.upload = this.form.querySelector('[type="file"]') ? this.form.querySelector('[type="file"]') : false;
    this.professions = this.form.querySelectorAll('[name="checkbox-profession"]');
    this.materials = this.form.querySelectorAll('[name="checkbox-materials"]');
    this.txtArea = this.form.querySelector("textarea");
    this.isRu = false;
    this.message = {
      failure: {
    ...
    if (this.upload) {
      ...
      open.addEventListener("click", () => {
        if (this.files.length >= 5) {
          container.closest(".form__upload").querySelector(".error").style.display = "block";
      ...
      this.upload.addEventListener("change", () => {
        if (!this.upload.files.length || this.upload.files.length > 5) {
          return;
        }

        if (this.upload.files.length + this.files.length > 5) {
          let end = 5 - this.files.length;
          let arr = [...this.upload.files].slice(0, end);
          this.files = [...arr, ...this.files];
        } else {
          this.files = [...this.upload.files, ...this.files];
        }

        container.innerHTML = ``;
        this.files.forEach(_ref => {
          let {
            name = file[0].name
          } = _ref;
          container.insertAdjacentHTML("afterbegin", `
          <div class="form__upload-item d-flex t-secondary">
          <div class="pic d-flex"> <svg class="icon">
            <use xlink:href="#pic"></use>
          </svg></div>
          <div class="name fz-14 "><span>${name}</span></div>
          <div class="delete" data-name="${name}">&times;</div>
        </div>
            `);
        });
      });
      container.addEventListener("click", event => {
        ...
        const block = container.querySelector(`[data-name="${name}"]`).closest(".form__upload-item");
        block.classList.add("removing");
        setTimeout(() => block.remove(), 300);

        if (this.files.length < 5) {
          container.closest(".form__upload").querySelector(".error").style.display = "none";
  ...
  validateEmptyField() {
    ...
    this.inputs.forEach(input => {
      if (input.name === "name") {
        if (!input.value.trim()) {
          ...
          input.nextElementSibling.innerHTML = `${!this.isRu ? field.ua : field.ru}`;
        ...
        if (input.value.indexOf("_") === -1) {
          ...
          input.parentNode.classList.add("invalid");
          input.nextElementSibling.innerHTML = `${!this.isRu ? field.ua : field.en}`;
          return isValid = false;
        }
    ...
    if (validator.name && validator.tel && validator.email) {
      return isValid;
    }
  }
  ...
  createMask(input) {
    ...
    let mask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](input, maskOptions);
  }
    ...
    this.inputs.forEach(input => {
      if (input.name === "name") {
        ...
        input.addEventListener("input", () => {
          this.formData.city = input.value;
        });
      } else {
        return;
      }
    });
    this.txtArea.addEventListener("input", () => {
      this.formData.info = this.txtArea.value;
    });
  }
  ...
  checkNameInput(input) {
    ...
    input.addEventListener("input", () => {
      ...
      if (!isValid) {
        input.nextElementSibling.innerHTML = `${!this.isRu ? name.ua : name.en}`;
      } else {
        input.nextElementSibling.innerText = "";
      }
    });
  ...
  checkEmailInput(input) {
    ...
    input.addEventListener("input", () => {
      ...
      if (!isValid) {
        input.nextElementSibling.innerHTML = `${!this.isRu ? email.ua : email.en}`;
      } else {
        input.nextElementSibling.innerText = "";
      }
    });
  ...
  checkPhoneInput(input) {
    ...
    input.addEventListener("input", () => {
      ...
      if (!isValid) {
        input.nextElementSibling.innerHTML = `${!this.isRu ? template.ua : template.en}`;
      } else {
        input.nextElementSibling.innerText = "";
      }
    });
  ...
  resetForm(btn) {
    ...
    this.form.querySelector("[data-container]").innerHTML = "";
    this.form.reset();
    this.checkInputs();
  }
  ...
  async postData(url, data, btn) {
    try {
      ...
      Object(_modalsEvents__WEBPACK_IMPORTED_MODULE_2__["default"])(btn);
      this.resetForm(btn);
    } catch (error) {
      btn.error = true;
      Object(_modalsEvents__WEBPACK_IMPORTED_MODULE_2__["default"])(btn);
  ...
  addCheckboxesValue(arr, name) {
    this.formData[name] = [];
    arr.forEach(input => {
      if (input.checked) {
        this.formData[name] = [input.value, ...this.formData[name]];
      }
    });

    if (this.formData[name].length) {
      this.formData[name] = this.formData[name].join(", ");
    } else {
      this.formData[name] = "";
    }
  }
  ...
  init() {
    ...
    this.form.addEventListener("submit", e => {
      ...
      if (this.validateEmptyField()) {
        e.submitter.dataset.send = true;

        if (this.types.length && this.professions.length && this.materials.length) {
          this.addCheckboxesValue(this.types, "types");
          this.addCheckboxesValue(this.professions, "professions");
          this.addCheckboxesValue(this.materials, "materials");
        }

        this.formData.title = this.form.dataset.title;
        this.formData.region = _selected__WEBPACK_IMPORTED_MODULE_1__["default"].region;
        this.formData.types = _selected__WEBPACK_IMPORTED_MODULE_1__["default"].region;

        if (this.form.dataset.title === "Запросити допомогу") {
          ...
          data.append(`action`, "create_ads");
          this.createAd(data);
        }

        e.submitter.classList.add("disabled");
        e.submitter.innerHTML = `<span class="spinner-wrapper"><svg class="icon">
        <use xlink:href="#spinner-ac"></use>
      </svg></span>`;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return academy; });
  ...
  items.forEach(el => {
    ...
    button.addEventListener("click", () => {
      if (el.dataset.open !== "true") {
        ...
        button.closest('.accordion__header').classList.add("active");
      } else {
        el.dataset.open = "false";
        content.style.maxHeight = "0";
        button.closest('.accordion__header').classList.remove("active");
      }
    });
...
/***/ "./src/js/modules/adaptiveElements.js":
/*!********************************************!*\
  !*** ./src/js/modules/adaptiveElements.js ***!
  \********************************************/
/*! exports provided: default */
...
const adaptiveElements = () => {
  ...
  (_getElement = Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('#menu-btn')) === null || _getElement === void 0 ? void 0 : _getElement.addEventListener("click", () => {
    _elements__WEBPACK_IMPORTED_MODULE_0__["header"].classList.toggle("active");
  });

  if (matchMedia("(max-width: 992px)").matches) {
    if (document.querySelector(".objects")) {
      document.querySelectorAll(".objects-item.done").forEach(item => {
        item.querySelector(".objects-item__done").insertAdjacentElement("beforebegin", item.querySelector(".budget"));
      });
    }
  }

  if (matchMedia("(max-width: 600px)").matches) {
    const logo = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".logo");
    logo.innerHTML = `
    <svg class="icon">
...
/* harmony default export */ __webpack_exports__["default"] = (adaptiveElements);

/***/ }),

/***/ "./src/js/modules/adsPage.js":
/*!***********************************!*\
  !*** ./src/js/modules/adsPage.js ***!
  \***********************************/
/*! exports provided: default */
...
/* harmony import */ var _selected__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selected */ "./src/js/modules/selected.js");
/* harmony import */ var _changePhotoSlider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./changePhotoSlider */ "./src/js/modules/changePhotoSlider.js");
/* harmony import */ var _pagination__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pagination */ "./src/js/modules/pagination.js");




function adsPage() {
  const adsPage = document.querySelector(".ads__page");

  if (adsPage) {
    const options = {
      itemsOnPage: 6
    };
    const parent = document.querySelector("[data-ads]");
    const ads = [...posts];

    const renderAds = function renderItems(arr, startPos, endPost) {
      document.body.scrollTop = 0;
      document.documentElement.scrollTop = 0;
      parent.innerHTML = `<span class="spinner-wrapper"><svg class="icon">
      <use xlink:href="#spinner"></use>
    </svg></span>`;
      setTimeout(() => {
        parent.innerHTML = ``;
        arr.slice(startPos, endPost).map(post => {
          parent.appendChild(renderPosts(post));
        });
        document.querySelectorAll("[data-adsPhotos]").forEach(item => {
          new _changePhotoSlider__WEBPACK_IMPORTED_MODULE_2__["default"](item).init();
        });
        Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["attachBtnModal"])('[data-number]');
      }, 700);
    };

    Object(_pagination__WEBPACK_IMPORTED_MODULE_3__["default"])(options, ads, renderAds); //   filterBtn.addEventListener("click", () => {
    //     modal.classList.add("modal-filter");
    //     modalBody.innerHTML = `
    //     <div class='filter-modal'>
    //       <h2 class=""fz-24 f-700>Фільтри</h2>
    //     <div class="fz-14 t-secondary">Фільтри допоможу зробити більш точний пошук</div>
    ...
    //     </div>
    //     `;
    //     new Dropdown(".region-help").init("region");
    //     renderCheckboxFilters(".types", typesWork, "types");
    //     new Modal(".modal").openModal();
    //     console.log(selected);
    //   });
  } // new Dropdown(".region-filter").init("region");
  // const types = document.querySelectorAll('[name="checkbox-types"]');
  // const profession = document.querySelectorAll('[name="checkbox-profession"]');
  // const statusItem = document.querySelectorAll('[name="checkbox-status"]');
  // const filterBtn = document.querySelector("[data-filter]");
  // const cleanBtn = document.querySelector("[data-clean]");
  // const showobjectsNavBtn = document.querySelector(".objects__show-nav");
  // const checkboxMaterials = document.querySelectorAll(
  ...
  //   parent.innerHTML = "";
  //   clearSelect();
  //   clearCheckbox(types, "types");
  //   clearCheckbox(profession, "profession");
  //   clearCheckbox(checkboxMaterials, "materials");
  //   clearCheckbox(statusItem, "status");
  //   searchResult.querySelector(".search-selected").innerHTML = "";
  //   searchResult.querySelector(".search-types").innerHTML = ``;
  //   searchResult.querySelector(".search-profession").innerHTML = ``;
  //   searchResult.querySelector(".search-materials").innerHTML = ``;
  //   searchResult.querySelector(".search-status").innerHTML = ``;
  ...
  //   selected.materials = [];
  //   selected.status = [];
  //   selectCheckbox(types);
  //   selectCheckbox(profession);
  //   selectCheckbox(checkboxMaterials);
  //   selectCheckbox(statusItem);
  //   let selectedPosts = filtredSelected(posts, "region");
  //   searchResult.querySelector(".search-selected").innerHTML = selected.region
  //     ? `<span>${selected.region}</span>`
  //     : "";
  //   searchResult.querySelector(
  //     ".search-types"
  //   ).innerHTML = `${renderFilterLabels(selected.types)}`;
  //   searchResult.querySelector(
  //     ".search-profession"
  //   ).innerHTML = `${renderFilterLabels(selected.profession)}`;
  //   searchResult.querySelector(
  //     ".search-materials"
  //   ).innerHTML = `${renderFilterLabels(selected.materials)}`;
  //   searchResult.querySelector(
  //     ".search-status"
  //   ).innerHTML = `${renderFilterLabels(selected.status)}`;
  //   if (
  //     selected.region === "" &&
  //     !selected.types.length &&
  //     !selected.profession.length &&
  ...
  //     }
  //     renderAllPosts(selectedPosts);
  //   } else if (selected.region === "") {
  //     selectedItems(selected, posts);
  //   } else if (selected.region !== "") {
  //     selectedItems(selected, selectedPosts);
  //   } else {
  //     return renderNoPosts();
  //   }
  // });
  // showobjectsNavBtn.addEventListener("click", function () {
  //   this.classList.toggle("active");
  //   document.querySelector(".objects__nav").classList.toggle("active");
  // });

}

function searchDuplicats(arr) {
  return arr.filter((el, i) => arr.indexOf(el) === i);
}

function clearCheckbox(arr, arg) {
  arr.forEach(input => {
    input.checked = false;
  });

  if (arg) {
    _selected__WEBPACK_IMPORTED_MODULE_1__["default"][`${arg}`] = [];
  }
}

function clearSelect() {
  _selected__WEBPACK_IMPORTED_MODULE_1__["default"].region = "";
  document.querySelector(".dropdown__selected ").innerText = "Оберіть область";
  document.querySelector(".dropdown__selected ").classList.remove("select");
  document.querySelector(".dropdown__selected ").dataset.region = "region";
}

function selectCheckbox(arr) {
  if (arr.length > 0) {
    let name = "";
    let data = [];
    arr.forEach(input => {
    ...
    return _selected__WEBPACK_IMPORTED_MODULE_1__["default"][`${name[1]}`] = [...data];
  }
}

function filtredSelected(arr, arg) {
  if (arg === "region") {
    return arr.filter(post => post.region === _selected__WEBPACK_IMPORTED_MODULE_1__["default"].region || post.city === _selected__WEBPACK_IMPORTED_MODULE_1__["default"].region);
  } else if (arg === "materials") {
    let filteredArr = [];
    _selected__WEBPACK_IMPORTED_MODULE_1__["default"][`${arg}`].forEach(item => {
      arr.forEach(post => {
        if (post[`${arg}`] === item) {
          filteredArr = [post, ...filteredArr];
        }
      });
    });
    return filteredArr;
    ...
    _selected__WEBPACK_IMPORTED_MODULE_1__["default"][`${arg}`].forEach(item => {
      arr.forEach(post => {
        if (post[`${arg}`] && post[`${arg}`].length) {
          post[`${arg}`].forEach(status => {
            if (status === item) {
              filteredArr = [post, ...filteredArr];
            }
          });
...
function renderFiltered(arr) {
  if (arr.length > 0) {
    return renderAllPosts(arr);
  }

  return renderNoPosts();
}

function renderSelected(arr, target) {
  let selectedOne = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  let selectedTwo = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;

  if (!selectedOne && !selectedTwo) {
    return renderFiltered(searchDuplicats(filtredSelected(arr, target)));
  }

  if (selectedOne) {
    if (selectedTwo) {
      return renderFiltered(searchDuplicats(filtredSelected(filtredSelected(filtredSelected(arr, target), selectedOne), selectedTwo)));
    }

    return renderFiltered(searchDuplicats(filtredSelected(filtredSelected(arr, target), selectedOne)));
  }
}

function selectedItems(selected, arr) {
  if (!selected.types.length && !selected.profession.length && !selected.materials.length && !selected.status.length) {
    return;
  }

  if (selected.types.length && selected.profession.length && selected.materials.length && selected.status.length) {
    return renderFiltered(filtredSelected(filtredSelected(filtredSelected(filtredSelected(arr, "types"), "profession"), "materials"), "status"));
  }

  if (selected.types.length) {
    if (!selected.profession.length && !selected.materials.length && !selected.status.length) {
      return renderSelected(arr, "types");
    }

    if (selected.profession.length) {
      if (selected.materials.length && !selected.status.length) {
        return renderSelected(arr, "types", "profession", "materials");
      }

      if (!selected.materials.length && selected.status.length) {
        return renderSelected(arr, "types", "profession", "status");
      }

      return renderSelected(arr, "types", "profession");
    }

    if (selected.materials.length) {
      if (!selected.profession.length && selected.status.length) {
        return renderSelected(arr, "types", "materials", "status");
      }

      return renderSelected(arr, "types", "materials");
    }

    if (selected.status.length) {
      return renderSelected(arr, "types", "status");
    }
  }

  if (selected.profession.length) {
    if (selected.materials.length && !selected.status.length) {
      return renderSelected(arr, "profession", "materials");
    }

    if (!selected.materials.length && selected.status.length) {
      return renderSelected(arr, "profession", "status");
    }

    if (selected.materials.length && selected.status.length) {
      return renderSelected(arr, "profession", "materials", "status");
    }

    return renderSelected(arr, "profession");
  }

  if (selected.materials.length) {
    if (selected.status.length) {
      return renderSelected(arr, "materials", "status");
    }

    return renderSelected(arr, "materials");
  }

  if (selected.status.length) {
    return renderSelected(arr, "status");
  }
}

function renderAllPosts(arr) {
  try {
    parent.innerHTML = "";
    arr.forEach(post => {
      parent.appendChild(renderPosts(post));
      Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["attachBtnModal"])();
    });
  } catch (e) {
    console.log(e);
  }
...
function renderAllObjects(arr) {
  try {
    parentObj.innerHTML = "";
    arr.forEach(post => {
      parentObj.appendChild(renderObject(post));
      Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["attachBtnModal"])();
    });
  } catch (e) {
    console.log(e);
...
function renderNoPosts() {
  ...
  div.innerText = `Оголошень не знайдено`;
...
function renderPosts(post) {
  try {
    ...
    const div = document.createElement("div");
    div.classList = "ads-item";
    div.id = `ads-${postId}`;
    let path = `qwe`; // let imgPath = path + `/assets/img/no-image.png`;

    const typesItems = Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["createLabelsItem"])(types);
    const professionItems = Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["createLabelsItem"])(profession);
    photo = photo.filter(item => item !== null);
    div.innerHTML = `
<div class="ads-item__photos ads-item-photos" data-adsPhotos data-adsPhoto>
<div class="ads-item-photos__main pos-r ">
  <div class="image" data-mainPhoto><img src="#" alt="">
  </div>
  <div class="ads-item-photos__nav d-flex pos-a">
    <button class="prev">
...
<div class="ads-item-photos__pagination d-flex" data-pagination>
${photo.length ? Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderImages"])(photo) : Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderNoImg"])()}
...
<div class="ads-item__header d-flex">
<div>
  <div class="name f-600 fz-16">${name}</div>
  <div class="location f-600 t-secondary fz-16"> ${region} область,  ${city}</div>
</div>
<div class="date f-600 fz-16 t-secondary">${date}</div>
</div>
...
<div class="filter-items__wrapper">
  <div class="filter-items">
    <div class="filter-items__types">
      ...
      <div class="d-flex">
      ${typesItems ? Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderFilterLabels"])(typesItems) : "<span class='no-label'>Не вказано</span>"}
      </div>
    </div>
  </div>
  <div class="filter-items">
    <div class="filter-items__profession">
      <div class="filter-items__title fz-14 f-700">
        Хто потрібен:
      </div>
      <div class="d-flex">
      
  ${professionItems ? Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderFilterLabels"])(professionItems) : "<span class='no-label'>Не вказано</span>"}
      </div>
    </div>
  </div>
  <div class="filter-items">
    <div class="filter-items__materials">
      <div class="filter-items__title fz-14 f-700">
        Потреба матеріалів:
      </div>
      <div class="d-flex">
      ${materials ? Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderLabel"])(materials) : "<span class='no-label'>Не вказано</span>"}
      </div>
    </div>
  </div>
</div>
<div class="ads-item__btns d-flex">
${renderFooterPost(status, tel)}
</div>
</div>
...
function renderFooterPost(status, tel) {
  if (status && status.length > 0) {
    return `<div  class="btn success">Виконано</div>`;
  } else {
    return `<button type="button" class="btn btn_sm btn_ac" data-number='${tel}'>Зв'язатися з власником</button>`;
  }
}
...
/*!********************************!*\
  !*** ./src/js/modules/base.js ***!
  \********************************/
/*! exports provided: regions, profession, typesWork, materials, status */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "typesWork", function() { return typesWork; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "materials", function() { return materials; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "status", function() { return status; });
const base = {
  regions: ["Вінницька", "Волинська", "Дніпропетровська", "Донецька", "Житомирська", "Закарпатська", "Запорізька", "Івано-Франківська", "Київська", "Київ", "Кіровоградська", "Луганська", "Львівська", "Миколаївська", "Одеська", "Полтавська", "Рівненська", "Сумська", "Тернопільська", "Харківська", "Херсонська", "Хмельницька", "Черкаська", "Чернівецька", "Чернігівська"],
  // profession: [
  //   "Архітектор-проектувальник",
  //   "Монтажник вікон та дверей",
  //   "Електрозварювальник, газозварювальник",
  //   "Електромонтажник",
  //   "Каменяр",
  //   "Маляр-штукатур",
  //   "Покрівельник",
  //   "Прораб, керівник будівництва",
  //   "Різноробочий",
  //   "Сантехнік",
  //   "Спеціаліст із фундаментних робіт, бетонник",
  //   "Фахівець з фасадних робіт",
  //   "Фахівець із земляних робіт, трубоукладач",
  //   "Монолітник",
  //   "Теплотехник",
  // ],
  typesWork: ["Оздоблення/ремонт", "Вікна/двері/балкони", "Побутовий ремонт", "Електрика", "Розбір завалів", "Монтаж/демонтаж", "Інше"],
  profession: ["Різноробочі", "Штукатурщик", "Кровельник", "Віконщик", "Маляр", "Зварщик", "Каменяр", "Електрик", "Будівельник", "Комплексний підхід", "Інше"],
  materials: ["Потрібно купити", "Придбаю самостійно"],
  status: ["Виконано"]
};
const {
  regions,
...
/***/ "./src/js/modules/changePhotoSlider.js":
/*!*********************************************!*\
  !*** ./src/js/modules/changePhotoSlider.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ChangePhotoSlider; });
/* harmony import */ var _modalsEvents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modalsEvents */ "./src/js/modules/modalsEvents.js");

class ChangePhotoSlider {
  constructor(el) {
    this.wrapper = el;
    this.nav = this.wrapper.querySelector('.ads-item-photos__nav');
    this.btns = this.wrapper.querySelectorAll("button");
    this.pagination = this.wrapper.querySelector("[data-pagination]");
    this.previewItems = this.pagination.querySelectorAll(".image");
    this.mainPhoto = this.wrapper.querySelector("[data-mainphoto]");
    this.slideNumber = this.wrapper.querySelector("[data-number]");
  }

  renderActive(i) {
    this.slideNumber.innerText = i + 1;

    if (this.previewItems.length == 1) {
      this.nav.classList.add('d-none');
      this.pagination.classList.add('d-none');
      let src = this.previewItems[0].firstElementChild.src;
      this.mainPhoto.firstChild.src = src;
    }

    if (this.slideNumber.innerText == 1) {
      this.btns[0].classList.add("disabled");
      this.previewItems[0].classList.add("active");
    } else {
      this.btns[0].classList.remove("disabled");
    }

    if (this.slideNumber.innerText == this.previewItems.length) {
      removeClass(this.btns, "disabled");
      this.btns[1].classList.add("disabled");
    } else {
      this.btns[1].classList.remove("disabled");
    }

    if (i < this.previewItems.length) {
      let src = this.previewItems[i].firstElementChild.src;
      this.mainPhoto.firstChild.src = src;
      removeClass(this.previewItems, "active");
      this.previewItems[i].classList.add("active");
    } else {
      return;
    }
  }
  ...
  addIndexToPrev() {
    this.previewItems.forEach((item, i) => {
      item.dataset.imgItem = i + 1;
    });
  }

  imgPopup() {
    this.mainPhoto.addEventListener('click', () => {
      Object(_modalsEvents__WEBPACK_IMPORTED_MODULE_0__["default"])(this.mainPhoto);
    });
  }

  addZoomInfo() {
    const div = document.createElement('div');
    div.classList = 'pos-a zoom-info';
    this.wrapper.classList.add('pos-r');
    div.innerText = `${!isEn ? 'Для збільшення зображення - натисніть на фото' : ''}`;
    this.wrapper.insertAdjacentElement('afterbegin', div);
  }

  init() {
    this.addZoomInfo();
    this.addIndexToPrev();
    this.slideNumber.innerText = 1;
    this.renderActive(0);
    this.imgPopup();
    this.btns.forEach(btn => {
      ...
      btn.addEventListener("click", () => {
        if (btn.classList.contains("prev")) {
          if (this.slideNumber.innerText != 1) {
            this.slideNumber.innerText--;
            this.renderActive(+this.slideNumber.innerText - 1);
          }
        } else {
          if (this.slideNumber.innerText < this.previewItems.length) {
            this.slideNumber.innerText++;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ "./src/js/modules/base.js");
/* harmony import */ var _renderCheckboxFilters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderCheckboxFilters */ "./src/js/modules/renderCheckboxFilters.js");
...
const checkbox = () => {
  ...
  if (form) {
    Object(_renderCheckboxFilters__WEBPACK_IMPORTED_MODULE_1__["default"])(".types", _base__WEBPACK_IMPORTED_MODULE_0__["typesWork"], "types");
    Object(_renderCheckboxFilters__WEBPACK_IMPORTED_MODULE_1__["default"])(".profession", _base__WEBPACK_IMPORTED_MODULE_0__["profession"], "profession");
    Object(_renderCheckboxFilters__WEBPACK_IMPORTED_MODULE_1__["default"])(".materials", _base__WEBPACK_IMPORTED_MODULE_0__["materials"], "materials");
    const checkboxMaterials = document.querySelector(".materials").querySelectorAll("label");
    checkboxMaterials.forEach(item => {
      item.addEventListener("click", () => {
        if (item.querySelector("input").checked) {
          removeCheck(checkboxMaterials);
        } else {
          removeCheck(checkboxMaterials);
...
function renderCheckbox(selector) {
  const formWrapper = document.querySelector(selector);

  if (formWrapper) {
    const checkboxWrapper = formWrapper.querySelectorAll(".form__checkbox");
    checkboxWrapper.forEach(items => {
      const checkbox = items.querySelectorAll("input[type=checkbox]");
      checkbox.forEach(item => {
        const span = document.createElement("span");
        span.classList.add("check");
        span.innerHTML = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#F9E14B"><path d="M21 6.285l-11.16 12.733-6.84-6.018 1.319-1.49 5.341 4.686 9.865-11.196 1.475 1.285z"/></svg>`;
...
function renderCheckboxName(selector) {
  const formWrapper = document.querySelector(selector);

  if (formWrapper) {
    const listItem = formWrapper.querySelectorAll(".wpcf7-list-item");
    listItem.forEach(item => {
      const content = item.innerHTML;
      item.innerHTML = `<label class="d-flex justify-content-center align-items-center">${content}</label>`;
    });
  }
}

function removeCheck(arr) {
  let isRemove;
  arr.forEach(item => {
...
function createDonate(btn) {
  const payData = {
    merchantAccount: "www_dobrobat_in_ua5",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return donatePage; });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ "./src/js/modules/helpers.js");

function donatePage() {
  if (!Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getElement"])('.donate-page')) return;
}
...
/*!************************************!*\
  !*** ./src/js/modules/elements.js ***!
  \************************************/
/*! exports provided: page, header, footer, modal, modalBody, form, spinner, modalWrapper, loadItems, gtagBtns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gtagBtns", function() { return gtagBtns; });
...
const gtagBtns = document.querySelectorAll("[data-label]");
spinner.classList = "loading";
spinner.innerHTML = `<span class="spinner-wrapper"><svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" viewBox="0 0 100 100" >

<g transform="rotate(0 50 50)">
  <rect x="47" y="24" rx="3" ry="6" width="6" height="12" fill="#FCD80C">
...
const loadItems = document.createElement("span");
loadItems.classList = "spinner-wrapper hide";
loadItems.innerHTML = `<svg class="icon"><use xlink:href="#spinner"></use></svg>`;


/***/ }),

/***/ "./src/js/modules/eventsPage.js":
/*!**************************************!*\
  !*** ./src/js/modules/eventsPage.js ***!
  \**************************************/
/*! exports provided: default */
...
function eventsPage() {
  if (Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getElement"])('.events-page')) {
    Object(_accordion__WEBPACK_IMPORTED_MODULE_1__["default"])('.accordion', '.accordion__header button', '.accordion__content');
  }
}
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["Autoplay"], swiper__WEBPACK_IMPORTED_MODULE_0__["Thumbs"], swiper__WEBPACK_IMPORTED_MODULE_0__["Lazy"]]);
...
const gallerySlider = () => {
  ...
  const swipeRenewedDonatePage = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".donate-page-objects__renewed", {
    slidesPerView: 4,
    spaceBetween: 20,
    preloadImages: false,
    lazy: true,
    navigation: {
      nextEl: ".donate-page-objects__renewed__next",
      prevEl: ".donate-page-objects__renewed__prev"
    },
    breakpoints: {
      1200: {
        slidesPerView: 4
    ...
    on: {
      slideChange: function () {
        ...
        Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.donate-page-objects__renewed').querySelector(".counter__current").innerHTML = `${currentSlide}`;
      },
      beforeInit: function () {
        let numOfSlides = this.wrapperEl.querySelectorAll(".swiper-slide").length;
        Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.donate-page-objects__renewed').querySelector(".counter__total").innerHTML = `${numOfSlides}`;
      }
    }
  });

  if (Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])(".heroes-slider")) {
    const swipeHeroesSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".heroes-slider", {
      slidesPerView: 1.5,
      spaceBetween: 30,
      preloadImages: false,
      lazy: true,
      navigation: {
        nextEl: ".heroes-slider__next",
        prevEl: ".heroes-slider__prev"
      },
      breakpoints: {
        992: {
          slidesPerView: 1.5,
      ...
      on: {
        slideChange: function () {
          let currentSlide = this.realIndex + 1;
          Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.heroes-slider').querySelector(".counter__current").innerHTML = `${currentSlide}`;
        },
        beforeInit: function () {
          let numOfSlides = this.wrapperEl.querySelectorAll(".swiper-slide").length;
          Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.heroes-slider').querySelector(".counter__total").innerHTML = `${numOfSlides}`;
        }
      }
    });
  }

  if (Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])(".heroes-item__gallery")) {
    const swiperHeroesItemSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".heroes-item__gallery", {
      slidesPerView: 1.05,
      spaceBetween: 10,
      preloadImages: false,
      lazy: true,
      navigation: {
        nextEl: ".heroes-item__gallery-slider__next",
        prevEl: ".heroes-item__gallery-slider__prev"
      },
      breakpoints: {
        //     992: {
        //          spaceBetween: 20,
      ...
      on: {
        slideChange: function () {
          let currentSlide = this.realIndex + 1;
          Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.heroes-item__gallery').querySelector(".counter__current").innerHTML = `${currentSlide}`;
        },
        beforeInit: function () {
          let numOfSlides = this.wrapperEl.querySelectorAll(".swiper-slide").length;
          Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.heroes-item__gallery').querySelector(".counter__total").innerHTML = `${numOfSlides}`;
        }
      }
    });
  }
  ...
  const swiperMainScreenNews = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".main-screen__news", {
    slidesPerView: 1,
    // spaceBetween: 10,
    // loop: true,
    // runCallbacksOnInit: true,
    ...
    on: {
      slideChange: function () {
        let currentSlide = this.realIndex + 1;
        Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.main-screen__news').querySelector(".counter__current").innerHTML = `${currentSlide}`;
      },
      beforeInit: function () {
        let numOfSlides = this.wrapperEl.querySelectorAll(".swiper-slide").length;
        Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.main-screen__news').querySelector(".counter__total").innerHTML = `${numOfSlides}`;
      }
    },
    breakpoints: {
      1440: {
  ...
  const swiperPartners = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".partners-support", {
    slidesPerView: 4,
    spaceBetween: 20,
    loop: true,
    centeredSlides: false,
    navigation: {
      nextEl: ".partners-support__next",
      prevEl: ".partners-support__prev"
    },
    breakpoints: {
      // 1200: {
      //   slidesPerView: 4,
  ...
  const swiperProject = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".project-slider", {
    slidesPerView: 1,
    spaceBetween: 0,
    loop: true,
    centeredSlides: false,
    navigation: {
      nextEl: ".next_slideProject",
      prevEl: ".prev_slideProject"
    },
    autoplay: {
      delay: 5000
    }
  ...
  if (document.querySelector(".single-news")) {
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".single-news-thumbs", {
      // loop: true,
      spaceBetween: 10,
      slidesPerView: 7,
      freeMode: true,
    ...
    var swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".single-news-swiper", {
      // loop: true,
      spaceBetween: 10,
      thumbs: {
        swiper: swiper
  ...
  if (document.querySelector(".thanks-list__photo")) {
    const swiperNewsSingle = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".thanks-list__photo", {
      slidesPerView: 1,
      spaceBetween: 10,
      loop: false,
      centeredSlides: true,
      navigation: {
        nextEl: ".next_thanksList",
        prevEl: ".prev_thanksList"
      },
      autoplay: {
        delay: 5000
      }
  ...
  if (document.querySelector(".celebrity")) {
    const swiperCelebrity = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".celebrity", {
      slidesPerView: 4,
      spaceBetween: 20,
      loop: true,
      navigation: {
        nextEl: ".celebrity__next",
        prevEl: ".celebrity__prev"
      },
      autoplay: {
        delay: 4000
      },
  ...
  if (Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["getElement"])('.academy')) {
    const swiperAcademyPageSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".academy-page__slider", {
      slidesPerView: 1,
      spaceBetween: 25,
      // loop: true,
      // runCallbacksOnInit: true,
      navigation: {
        nextEl: ".swiper-academy-page__next",
        prevEl: ".swiper-academy-page__prev"
      },
      breakpoints: {
        1600: {
          slidesPerView: 4
...
/*!***********************************!*\
  !*** ./src/js/modules/helpers.js ***!
  \***********************************/
/*! exports provided: lenghtCorrect, arrayToChunks, getElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lenghtCorrect", function() { return lenghtCorrect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "arrayToChunks", function() { return arrayToChunks; });
...
function getElement(selector) {
  let elements = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  return elements ? document.querySelectorAll(selector) : document.querySelector(selector);
}
...
/***/ "./src/js/modules/modalsEvents.js":
/*!****************************************!*\
  !*** ./src/js/modules/modalsEvents.js ***!
  \****************************************/
/*! exports provided: default */
...
const content = {
  name: {
    en: "Перезвоните мне",
    ua: "ГРОМАДСЬКА ОРГАНІЗАЦІЯ"
  },
  organisation: {
    en: "Оставить заявку",
    ua: '"ДОБРОБАТ - ДОБРОВОЛЬЧИЙ БУДІВЕЛЬНИЙ БАТАЛЬЙОН"'
  },
  codeTitle: {
    en: "Ваше имя*",
    ua: "Код ЄДРПОУ"
  ...
  iban: {
    en: "№ UA803003460000026009000002537",
    ua: "№ UA803003460000026009000002537"
  },
  card: {
    en: "5168 7453 0224 2372",
    ua: "5168 7453 0224 2372"
  }
};
function modalsEvents(target) {
  ...
  if (target.hasAttribute("data-number")) {
    renderAdsItemModal(target);
  }

  if (target.hasAttribute("data-donate")) {
    renderDonateModal(target);
  ...
  if (target.hasAttribute("data-mainphoto")) {
    renderImgModal(target);
  }
  ...
  new _popups__WEBPACK_IMPORTED_MODULE_1__["default"](".modal").openModal();
}

function renderImgModal(target) {
  _elements__WEBPACK_IMPORTED_MODULE_0__["modal"].classList.add("modal-img");
  let src = target.firstChild.src;
...
<button   data-id='${target.dataset.donate}' class="btn btn_ac"  data-lang="${!isEn ? "UA" : "EN"}" data-label='usd' data-currency="USD">
  ...
  <button  data-id='${target.dataset.donate}' class="btn btn_ac" data-lang="${!isEn ? "UA" : "EN"}"  data-label='eur' data-currency="EUR">
    ...
    <input name="merchantAccount" value="www_dobrobat_in_ua5">
...
function renderError() {
  _elements__WEBPACK_IMPORTED_MODULE_0__["modal"].classList.add("error");
  _elements__WEBPACK_IMPORTED_MODULE_0__["modalBody"].innerHTML = `<div class="error-modal d-flex">
  <div class="pic">
    <svg class="icon">
...
function renderThankModal() {
  _elements__WEBPACK_IMPORTED_MODULE_0__["modal"].classList.add("modal-thank");
  _elements__WEBPACK_IMPORTED_MODULE_0__["modalBody"].innerHTML = `<div class='thank-modal t-center'>

  <h2 class="fz-34 ">
  Дякуємо за підтримку!
</h2>
<div class="fz-34 f-500">
  Скоро з Вами зв’яжеться координатор проекту та повідомить деталі!
</div>
<a href="https://t.me/dobrobat_in_ua" class="btn btn_ac">
     <span class="fz-14">     ПІДПИСАТИСЬ НА КАНАЛ</span>
        </a>
...
function renderAdsItemModal(target) {
  _elements__WEBPACK_IMPORTED_MODULE_0__["modal"].classList.add("modal-number");
  _elements__WEBPACK_IMPORTED_MODULE_0__["modalBody"].innerHTML = `
  <div class="ads-item__modal">
  <div class="wrapper fz-18">
<h4><strong class="d-block fz-24"> ${!isEn ? "Увага!" : "Attention!"} </strong> ${!isEn ? "Пам’ятайте про заходи безпеки:" : "Remember the safety measures:"} </h4>
<ul>
      <li class='fz-14'>
        Всі оголошення на сайті - безкоштовні. Якщо від вас вимагають гроші на карту - це шахраї.
      </li>
  ...
  <div class="number"> Номер телефону власника: <strong>${target.dataset.number}</strong></div>

  <a href="tel:${target.dataset.number}" class="btn btn_outline-ac">
    <span class='tel'>
    <svg class="icon">
    <use xlink:href="#tel"></use>
  </svg>
    </span>
    <span>Зв’язатись з власником</span>
    </a>
...
function newsPage() {
  const newsPage = document.querySelector(".news__page");

  if (newsPage) {
    const parent = newsPage.querySelector("[data-news]");
    const btn = document.createElement("button");
    btn.classList = "btn btn_outline btn_sm m-a";
    btn.innerHTML = `<span class="fz-14">${!isEn ? "Переглянути ще новини" : "See more"}</span>`;
    btn.dataset.newsbtn = "";
    let index = 1;
    let newsItems = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["arrayToChunks"])(4, news);
    parent.appendChild(_elements__WEBPACK_IMPORTED_MODULE_1__["spinner"]);
    setTimeout(() => {
      parent.innerHTML = "";
      renderArticles(newsItems, 0, parent);
      parent.insertAdjacentElement("afterend", btn);
    }, 750);
    btn.addEventListener("click", () => {
      btn.style.opacity = "0";
      btn.insertAdjacentElement("beforebegin", _elements__WEBPACK_IMPORTED_MODULE_1__["spinner"]);
      setTimeout(() => {
        _elements__WEBPACK_IMPORTED_MODULE_1__["spinner"].remove();
        btn.style.opacity = "1";
        renderArticles(newsItems, index, parent);
        index++;
      }, 500);
    });

    function renderArticles(arr, i, parent) {
      if (i < arr.length) {
        const fragment = document.createDocumentFragment();
        arr[i].forEach(_ref => {
          let {
          ...
          wrapper.classList = "news-item d-flex";
          let shortDescr = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["lenghtCorrect"])(descr, 200);
          wrapper.innerHTML = `
          <div class="news-item__title"> 
            <h3 class="fz-34 f-600">${title}</h3>
            <div class="date fz-16">${!isEn ? "Додано" : "Published"}: ${date}</div>
          </div>
          <div class="news-item__descr">
            <div class="descr fz-18 ${!shortDescr ? 'none' : ''}">${shortDescr}</div>  
            <a href="${url}" class="t-upper fz-14 f-600">${!isEn ? "Переглянути" : "View"}</a> 
      ...
      `;
          fragment.appendChild(wrapper); // return fragment;
        });
...
/***/ "./src/js/modules/objectsPage.js":
/*!***************************************!*\
  !*** ./src/js/modules/objectsPage.js ***!
  \***************************************/
/*! exports provided: default, renderBtns, renderBudget, renderStatusIcon, renderStatus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return objectsPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderBtns", function() { return renderBtns; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderBudget", function() { return renderBudget; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderStatusIcon", function() { return renderStatusIcon; });
...
function objectsPage() {
  const objectsPage = document.querySelector(".objects__page");
  ...
  if (objectsPage) {
    ...
    const renderObj = function (arr, startPos, endPost) {
      document.body.scrollTop = 0;
      document.documentElement.scrollTop = 0;
      _elements__WEBPACK_IMPORTED_MODULE_1__["loadItems"].classList.remove("d-none");
      _elements__WEBPACK_IMPORTED_MODULE_1__["loadItems"].classList.remove("hide");
      _elements__WEBPACK_IMPORTED_MODULE_1__["loadItems"].classList.add("show");
      ...
      setTimeout(() => {
        _elements__WEBPACK_IMPORTED_MODULE_1__["loadItems"].classList.remove("show");
        _elements__WEBPACK_IMPORTED_MODULE_1__["loadItems"].classList.add("hide");
        _elements__WEBPACK_IMPORTED_MODULE_1__["loadItems"].classList.add("d-none");
...
function renderObject(post) {
  try {
    ...
    const div = document.createElement("div");
    div.classList = "objects-item";
    status === '3' ? div.classList.add('done') : '';
    div.id = `objects-${postId}`;
    const typesItems = Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["createLabelsItem"])(types);
    const typesItems_en = Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["createLabelsItem"])(types_en);
    const infrostructureItems = Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["createLabelsItem"])(infrostructure);
    const infrostructureItems_en = Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["createLabelsItem"])(infrostructure_en);
    div.innerHTML = `
<div class="objects-item__photos ads-item-photos" data-objectsPhotos>
<div class="objects-item-photos__main pos-r ">
${renderStatusIcon(status)}
  <div class="image" >${photo ? renderImages(photo, isEn, link, title, title_en) : Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderNoImg"])()}
  </div>
</div>
...
<div>
  ${renderTitle(isEn, title, title_en, link)}
  <div class="location f-600 t-secondary fz-16"> ${!isEn ? region + " область" : region_en} ,  ${!isEn ? city : city_en}</div>
</div>
<div>
<div class="date f-600 fz-16 t-secondary">${date}</div>
<div class="f-500 fz-14 t-secondary">#${postId}</div>
</div>
...
${renderBudget(status, start, goal)}


</div>
<div class="objects-item__filter pos-r d-flex">
<div class="filter-items__wrapper">
${renderStatus(status)}
<div class="filter-items">
<div class="filter-items__infrastructure">
  <div class="filter-items__title fz-14 f-700">
  ${!isEn ? "Тип інфраструктури:" : "Type of infrastructure:"}
    
  </div>
  <div class="d-flex">
  ${!isEn ? infrostructureItems ? Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderFilterLabels"])(infrostructureItems) : "<span class='no-label'>'Не вказано'</span>" : infrostructureItems_en ? Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderFilterLabels"])(infrostructureItems_en) : "<span class='no-label'>Not specified</span>"}
  ...
  <div class="filter-items">
    <div class="filter-items__types">
      <div class="filter-items__title fz-14 f-700">
        ${!isEn ? "Види ремонтних робіт:" : "See repair activities:"}
      </div>
      <div class="d-flex">
      ${!isEn ? typesItems ? Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderFilterLabels"])(typesItems) : "<span class='no-label'>Не вказано</span>" : typesItems_en ? Object(_postsRenderHelpFunc__WEBPACK_IMPORTED_MODULE_0__["renderFilterLabels"])(typesItems_en) : "<span class='no-label'>Not specified</span>"}
...
function renderTitle(isEn, title, title_en, link) {
  if (isEn) {
    return `
    <div class="name f-600 fz-16">${title_en}</div>
    `;
  } else {
    return `  <a href="${link}" target="_blank" class="name f-600 fz-16">${title}</a>`;
  }
}

function renderImages(arr, isEn, link, title, title_en) {
  let wrapper = "";
  arr.forEach((item, i) => {
    if (i <= 0) {
      if (item) {
        if (isEn) {
          wrapper += `<div class="image"><img class="lazyload" data-src="${item.img}" alt="${title_en}"/></div>`;
        } else {
          wrapper += `<a href="${link}" class="image d-flex" target="_blank"><img class="lazyload" data-src="${item.img}" alt='${isEn ? title_en : title}'/></a>`;
        }
      }
    }
  });
...
function renderStatusIcon(status) {
  switch (status) {
    case "1":
      return `<div class='status pos-a status_1'>
        <svg class="icon">
          <use xlink:href="#status-1"></use>
        </svg>
      </div>`;

    case "2":
      return `<div class='status pos-a status_2'>    
        <svg class="icon">
          <use xlink:href="#status-2"></use>
        </svg>
      </div>`;

    case "3":
      return `<div class='status pos-a status_3'>
        <svg class="icon">
...
function renderStatus(status) {
  if (status !== "3") {
    return `
    <div class="filter-items">
<div class="filter-items__status">
  <div class="filter-items__title fz-14 f-700">
  ${!isEn ? "Статус:" : "Status"}
...
function renderBtns(status, postId, doc) {
  if (status !== "3") {
    return `<div class="objects-item__btns d-flex">
    ...
    return `<div class="objects-item__done pos-a">${statusName(status)}</div>`;
  }
}

function renderBudget(status, start, goal) {
  if (status !== "3") {
    return `<div class="budget" data-start="${start}" data-goal="${goal}">
    <h3 class="t-secondary fz-16 f-600">
    ${!isEn ? "Сума інвестицій:" : "Donation amount:"}
    </h3>
    <div class="budget__info d-flex  f-600">
      <div class="start fz-24">
    
      </div>
      <div class="goal t-secondary">
    
      </div>
    
    </div>
    <div class="budget__progress pos-r">
      <span class="pos-a"></span>
    </div>
    </div>`;
  } else {
    return `<div class="budget budget_done">
    <h3 class="t-secondary fz-16 f-600">
    ${!isEn ? "Було зібрано" : "Donation amount"}
    </h3>
    <div class="budget__info d-flex  f-600">
  
      <div class="goal">
    ${!isEn ? goal : "≈" + Math.round(+goal / 36)} ${!isEn ? " грн" : " $"}
      </div>
...
function statusName(status) {
  switch (status) {
    ...
    case "3":
      return !isEn ? "ВІДНОВИЛИ" : "Renovated";
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return paginations; });
function paginations() {
  let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  let arr = arguments.length > 1 ? arguments[1] : undefined;
  let render = arguments.length > 2 ? arguments[2] : undefined;
  let defaultIndex = 1,
      itemsOnPage = options.itemsOnPage,
      pageIndex = Math.ceil(arr.length / itemsOnPage);
  let pagiWrapper = document.querySelector(".pagination");

  if (pageIndex > 1) {
    pagination(defaultIndex, pageIndex, render);
  } else {
    render(arr);
  }

  function pagination(index) {
    let pageLen = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : pageIndex;
    let render = arguments.length > 2 ? arguments[2] : undefined;
    ...
    for (let i = 0; i < rangeWithDots.length; i++) {
      ...
      if (rangeWithDots[i] == current) {
        ...
        paginationItem.addEventListener("click", e => e.preventDefault());
        paginationItem.classList.add("pagination__item");
      } else {
        paginationItem.classList.add("pagination__item");
        paginationItem.addEventListener("click", changePageIndex);
      }

      paginationItem.innerHTML = `
          <a >${rangeWithDots[i]}</a>
          `;
      pagiWrapper.append(paginationItem);
    } //re-render Post


    render(arr, current * itemsOnPage - itemsOnPage, current * itemsOnPage);
  }

  function changePageIndex(event) {
    let clickedItem = Number(event.target.innerText);
    pagination(clickedItem, pageIndex, render);
  }
}
...
class Modal {
  ...
  detachModalEvents() {
    if (this.modal.querySelector(".modal__close")) {
      this.modal.querySelector(".modal__close").removeEventListener("click", () => {
        this.closeModal(this.modal);
      });
    }
...
/***/ "./src/js/modules/postsRenderHelpFunc.js":
/*!***********************************************!*\
  !*** ./src/js/modules/postsRenderHelpFunc.js ***!
  \***********************************************/
/*! exports provided: renderFilterLabels, renderLabel, createLabelsItem, renderImages, renderNoImg, attachBtnModal, renderProgress */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderFilterLabels", function() { return renderFilterLabels; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderLabel", function() { return renderLabel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createLabelsItem", function() { return createLabelsItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderImages", function() { return renderImages; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderNoImg", function() { return renderNoImg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "attachBtnModal", function() { return attachBtnModal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderProgress", function() { return renderProgress; });
/* harmony import */ var _modalsEvents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modalsEvents */ "./src/js/modules/modalsEvents.js");


function renderFilterLabels(arr) {
  if (arr.length) {
    let t = "";
    arr.forEach(item => {
      t += `<span>${item}</span>`;
...
function renderImages(arr) {
  ...
  arr.forEach(item => {
    if (item) {
      if (item.img) {
        wrapper += `<div class="image"><img loading="lazy" src="${item.img}" alt='Фото'/>"alt=""></div>`; // wrapper += `<div class="image"><img src="${item.img}" alt='Фото'/>"alt=""></div>`;
      } else {
        wrapper += `<div class="image"><img  src="${item}" alt='Фото'/>"alt=""></div>`;
      }
    }
  });
  return wrapper;
...
function renderNoImg() {
  return ` <div class="image">
<img  src="${path}/assets/img/no-image.jpg" alt='Фото'/>"
    alt=""></div>`;
}

function attachBtnModal(selector) {
  const mBtns = document.querySelectorAll(selector);
  mBtns.forEach(item => {
    item.addEventListener("click", () => {
      Object(_modalsEvents__WEBPACK_IMPORTED_MODULE_0__["default"])(item);
    });
  });
}

function renderProgress() {
  if (document.querySelectorAll(".budget").length > 0) {
    document.querySelectorAll(".budget").forEach(item => {
      if (item.dataset.start && item.dataset.goal) {
        let start = +item.dataset.start;
        let goal = item.dataset.goal;
        item.querySelector(".start").innerText = `${!isEn ? start : "≈" + Math.round(+start / 36)}` + `${!isEn ? " грн" : " $"}`;
        item.querySelector(".goal").innerText = `${!isEn ? goal : "≈" + Math.round(+goal / 36)}` + `${!isEn ? " грн" : " $"}`;
        let progress = Math.ceil(start * 100 / goal);
...
/***/ "./src/js/modules/pressAboutPage.js":
/*!******************************************!*\
  !*** ./src/js/modules/pressAboutPage.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return pressAboutPage; });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ "./src/js/modules/helpers.js");
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elements */ "./src/js/modules/elements.js");


function pressAboutPage() {
  const pressAbout = document.querySelector(".press-about__page");

  if (pressAbout) {
    const parent = pressAbout.querySelector("[data-pressAbout]");
    const btn = document.createElement("button");
    btn.classList = "btn btn_outline btn_sm";
    btn.innerHTML = `<span class="fz-14">${!isEn ? "Що ще пишуть" : "See more"}</span>`;
    btn.dataset.pressbtn = "";
    let articles = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["arrayToChunks"])(9, press);
    let index = 1;
    parent.appendChild(_elements__WEBPACK_IMPORTED_MODULE_1__["spinner"]);
    setTimeout(() => {
      parent.innerHTML = "";
      renderArticles(articles, 0, parent);
    ...
    if (btn) {
      btn.addEventListener("click", () => {
        ...
        setTimeout(() => {
          _elements__WEBPACK_IMPORTED_MODULE_1__["spinner"].remove();
          btn.style.opacity = "1";
          renderArticles(articles, index, parent);
          index++;
        }, 500);
      });
    }
    ...
    function renderArticles(arr, i, parent) {
      if (i < arr.length) {
        ...
        arr[i].forEach(_ref => {
          ...
          const wrapper = document.createElement("div");
          wrapper.classList = "press-about__item";
          let titlePost = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["lenghtCorrect"])(title, 60); // if (title.length > 59) {
          //   titlePost = titleLenghtCorrect(".news-item__title");
          // }

          wrapper.innerHTML = `
          <div class='image-wrapper'>
        <div class="image">
        <img src="${mainImg}" alt="${titlePost}" class='lazyload'>
        </div>
        </div>
        <h3 class="fz-34 f-600">${titlePost}</h3>
          <div class="date fz-16">${!isEn ? "Опубліковано:" : ""} ${date}</div>
          <a href="${link}" class="t-upper fz-14 f-600">${!isEn ? "Переглянути" : "View the material"}</a>
      `;
...
/***/ "./src/js/modules/renderCheckboxFilters.js":
/*!*************************************************!*\
  !*** ./src/js/modules/renderCheckboxFilters.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return renderCheckboxFilters; });
function renderCheckboxFilters(selector, data, name) {
  const parent = document.querySelector(selector);
  const fragment = document.createDocumentFragment();
  data.forEach(item => {
    const div = document.createElement("div");
    div.classList = "form__checkbox";

    if (selector === '.materials') {
      div.innerHTML = `
  
      <label class="d-flex">
        <input type="checkbox" name="checkbox-${name}" value="${item}">
        <span class="check">

        </span>
        <span class="text-item fz-14">${item}</span>
      </label>
    `;
    } else {
      div.innerHTML = `
...
const scrollToAnchor = function () {
  ...
  links.forEach(link => {
    link.addEventListener("click", function (event) {
      ...
      const headerHeaight = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].offsetHeight;

      if (_elements__WEBPACK_IMPORTED_MODULE_0__["header"].classList.contains("active")) {
        _elements__WEBPACK_IMPORTED_MODULE_0__["header"].classList.toggle("active"); // headerNav.classList.toggle("active");
        // document.body.classList.toggle("active");
      }

      scrollToAnotherPage(blockID, "#about");
      scrollToAnotherPage(blockID, "#form");
      scrollToAnotherPage(blockID, "#donate");
      window.scrollTo({
...
function scrollToAnotherPage(el, target) {
  if (target) {
    if (el === target) {
      location.href = isEn ? `${loc}/en/${target}` : `${loc}${target}`;
    }
  } else {
    return;
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return singleNews; });
...
function singleNews() {
  const singleNews = document.querySelector(".single-news__page");

  if (singleNews && document.querySelector("[data-newsPhotos]")) {
    new _changePhotoSlider__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector("[data-newsPhotos]")).init();
  }
}

/***/ }),

/***/ "./src/js/modules/singleObjectPage.js":
/*!********************************************!*\
  !*** ./src/js/modules/singleObjectPage.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _objectsPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./objectsPage */ "./src/js/modules/objectsPage.js");
...
function singleObject() {
  ...
  if (singleObj) {
    const {
      ...
      postId,
      doc
    } = objects.find(item => item.postId == singleObj.querySelector('.single-obj').dataset.id);
    new _changePhotoSlider__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector("[data-objectsphotos]")).init();
    document.querySelector('.objects-item-photos__main ').insertAdjacentHTML('afterbegin', Object(_objectsPage__WEBPACK_IMPORTED_MODULE_2__["renderStatusIcon"])(status));
    document.querySelector('.filter-items__wrapper').insertAdjacentHTML('afterbegin', Object(_objectsPage__WEBPACK_IMPORTED_MODULE_2__["renderStatus"])(status));
    document.querySelector('.objects-item__footer').insertAdjacentHTML('afterbegin', Object(_objectsPage__WEBPACK_IMPORTED_MODULE_2__["renderBudget"])(status, start, goal));
    document.querySelector('.objects-item__footer').insertAdjacentHTML('beforeend', Object(_objectsPage__WEBPACK_IMPORTED_MODULE_2__["renderBtns"])(status, postId, doc));
    ...
    const obj = objects.filter(item => item.status === '3');
    obj.forEach(item => {
...
function renderItem(obj) {
  ...
  div.innerHTML = `            <div class="renewed-item  bg-white bdr-10">
    <div class="renewed-item__img pos-r">
      <div class="image"><img  data-src="${img}" alt="" class="swiper-lazy">
...
function tabs() {
  const tabsTarget = document.querySelectorAll("[data-target]"),
        tabContents = document.querySelectorAll("[data-content]");
  tabsTarget.forEach(tab => {
    tab.addEventListener("click", () => {
      const target = document.querySelector(tab.dataset.target);
      removeActive(tabContents);
      target.classList.add("active");
      removeActive(tabsTarget);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return thankPage; });
function thankPage() {
  if (document.querySelector('.section__thank-you')) {
