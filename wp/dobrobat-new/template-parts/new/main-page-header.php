<div class="flex items-center">
    <nav class="lg:mr-36">
        <ul class="hidden lg:flex">
            ...
            <li class="nav-link"><a href="#" class="scroll-to">Наші проєкти</a></li>
            <li class="nav-link"><a href="#" class="scroll-to">Новини</a></li>
            <li class="nav-link"><a href="#" class="scroll-to">Закупівлі</a></li>
            <li class="nav-link"><a href="#" class="scroll-to">Контакти</a></li>
        </ul>
    </nav>
