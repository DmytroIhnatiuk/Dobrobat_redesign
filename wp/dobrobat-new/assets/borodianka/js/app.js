(() => {
    var __webpack_modules__ = {
        989: (module, exports, __webpack_require__) => {
        ...
        236: (module, __unused_webpack_exports, __webpack_require__) => {
            function setup(env) {
                ...
                createDebug.humanize = __webpack_require__(301);
...
*/            Sister = function() {
        ...
        664: (module, exports, __webpack_require__) => {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
                value: true
            });
            var _PlayerStates = __webpack_require__(592);
        ...
        449: (module, exports, __webpack_require__) => {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
                value: true
            });
            var _debug = __webpack_require__(989);
            var _debug2 = _interopRequireDefault(_debug);
            var _FunctionStateMap = __webpack_require__(664);
            var _FunctionStateMap2 = _interopRequireDefault(_FunctionStateMap);
            var _eventNames = __webpack_require__(13);
            var _eventNames2 = _interopRequireDefault(_eventNames);
            var _functionNames = __webpack_require__(677);
        ...
        585: (module, exports, __webpack_require__) => {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
                value: true
            });
            var _sister = __webpack_require__(350);
            var _sister2 = _interopRequireDefault(_sister);
            var _YouTubePlayer = __webpack_require__(449);
            var _YouTubePlayer2 = _interopRequireDefault(_YouTubePlayer);
            var _loadYouTubeIframeApi = __webpack_require__(946);
        ...
        946: (module, exports, __webpack_require__) => {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
                value: true
            });
...
*/
        ...
        var dist = __webpack_require__(585);
        function initYoutube(elementSelector) {
            if (!getElement(elementSelector)) return;
            let players = {};
            getElements(elementSelector).forEach((item => {
                const video = getElement(".init-youtube-video", item);
                getElement(".image", item);
                getElement(".init-youtube-button ", item)?.addEventListener("click", (() => {
                    if (video) if (!players[video.id]) {
                        players[video.id] = dist(video.id, {
                            autoplay: 0,
                            controls: 0,
                            showinfo: 0,
                            enablejsapi: 1,
                        ...
                        players[video.id].on("stateChange", (event => {
                            if (event.data === window.YT.PlayerState.PLAYING) item.classList.add("active");
                            if (event.data === window.YT.PlayerState.PAUSED) item.classList.remove("active");
                            if (event.data === window.YT.PlayerState.BUFFERING) item.classList.add("active");
                        }));
                    } else setTimeout((() => {
            ...
            if (elementsNodeList_header) {
                ...
                if (burger && menu && body) burger.addEventListener("click", (() => {
                    ...
                    if (burger.classList.contains("active")) {
                        ...
                        elementsNodeList_header.classList.add("active");
                        setTimeout((() => {
        ...
        function aboutSwiper() {
            if (!getElement('[data-swiper="about"]')) return;
            new Swiper('[data-swiper="about"]', {
                modules: [ Navigation ],
                slidesPerView: 1.15,
                spaceBetween: 16,
                speed: 450,
                ...
                navigation: {
                    nextEl: getElement('[data-swiper="about"] .next'),
                    prevEl: getElement('[data-swiper="about"] .prev')
                }
            });
        }
        function goalSwiper() {
            if (!getElement('[data-swiper="goal"]')) return;
            new Swiper('[data-swiper="goal"]', {
                modules: [ Mousewheel ],
                slidesPerView: 1,
                spaceBetween: 0,
                mousewheel: true,
        ...
        function partnersSwiper() {
            if (!getElement('[data-swiper="partners"]')) return;
        ...
        function visualisationSwiper() {
            const thumbs = new Swiper('[data-swiper="visual-thumbs"]', {
                modules: [ freeMode ],
                loop: true,
                spaceBetween: 8,
                slidesPerView: 4,
            ...
            new Swiper('[data-swiper="visual"]', {
                modules: [ Navigation, Thumb ],
                loop: true,
                spaceBetween: 10,
                navigation: {
                    nextEl: getElement('[data-swiper="visual"] .next'),
                    prevEl: getElement('[data-swiper="visual"] .prev')
                },
                thumbs: {
                    swiper: thumbs
                }
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            try {
                ...
                partnersSwiper();
                visualisationSwiper();
                let panelsContainer = document.querySelector(".goal-container");
                const panels = gsapWithCSS.utils.toArray(".goal-container .goal");
